namespace sample_6_7 {
  partial class PivotOverview {
    ...
    private void InitializeComponent() {
      ...
      dataSourceColumnBinding1.ColumnName = "CapacityRequirement.Event.StartDate";
      ...
      dataSourceColumnBinding2.ColumnName = "CapacityRequirement.Event.StartDate";
      dataSourceColumnBinding2.GroupInterval = DevExpress.XtraPivotGrid.PivotGroupInterval.DateMonth;
      this.pivotGridField1.DataBinding = dataSourceColumnBinding2;
      ...
      dataSourceColumnBinding3.ColumnName = "CapacityRequirement.Name";
      this.fieldCapacityRequirementName1.DataBinding = dataSourceColumnBinding3;
      ...
      dataSourceColumnBinding4.ColumnName = "CapacityRequirement.Capacity";
      this.fieldCapacityRequirementCapacity1.DataBinding = dataSourceColumnBinding4;
      ...
      dataSourceColumnBinding5.ColumnName = "CapacityRequirement.RoomSetup";
      this.fieldCapacityRequirementRoomSetup1.DataBinding = dataSourceColumnBinding5;
      ...
      dataSourceColumnBinding6.ColumnName = "CapacityRequirement.Event.Name";
      this.fieldCapacityRequirementEventName1.DataBinding = dataSourceColumnBinding6;
      ...
      dataSourceColumnBinding7.ColumnName = "CapacityRequirement.Event.StartDate";
      this.fieldCapacityRequirementEventStartDate1.DataBinding = dataSourceColumnBinding7;
      ...
      dataSourceColumnBinding8.ColumnName = "CapacityRequirement.Event.EndDate";
      this.fieldCapacityRequirementEventEndDate1.DataBinding = dataSourceColumnBinding8;
      ...
      dataSourceColumnBinding9.ColumnName = "CapacityRequirement.Event.Venue.Name";
      this.fieldCapacityRequirementEventVenueName1.DataBinding = dataSourceColumnBinding9;
      ...
      dataSourceColumnBinding10.ColumnName = "CapacityRequirement.Event.Customer.Name";
      this.fieldCapacityRequirementEventCustomerName1.DataBinding = dataSourceColumnBinding10;
      ...
      dataSourceColumnBinding11.ColumnName = "CapacityRequirement.RoomBooking.Room.Name";
      this.fieldRoomName2.DataBinding = dataSourceColumnBinding11;
      ...
      dataSourceColumnBinding12.ColumnName = "StartTime";
      this.fieldStartTime3.DataBinding = dataSourceColumnBinding12;
      ...
      dataSourceColumnBinding13.ColumnName = "EndTime";
      this.fieldEndTime3.DataBinding = dataSourceColumnBinding13;
      ...
      dataSourceColumnBinding14.ColumnName = "CapacityRequirement.Capacity";
      this.fieldCapacityRequirementCapacity2.DataBinding = dataSourceColumnBinding14;
      ...
      this.selectSeriesBarItem1.EditValue = "Grand Total | Capacity (Average)";
      ...
      xyDiagram1.AxisX.Title.Text = "Venue Room Setup";
      xyDiagram1.AxisX.VisibleInPanesSerializable = "-1";
      xyDiagram1.AxisY.Title.Text = "Capacity (Average) Capacity (Sum)";
      ...
      this.chartControl1.Size = new System.Drawing.Size(1000, 156);
